...
namespace IdentitySample.Controllers
{
    ...
    {
        /// <summary>
        /// This controller is created by default for some operation like logins and password reset
        /// </summary>
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return RedirectToAction("PschangeSuccess");
            }
            AddErrors(result);
            return View(model);
        }

        public async  Task<ActionResult> PschangeSuccess()
        {
            ViewBag.photoLink = await getPicLink();
            return View();
        }
